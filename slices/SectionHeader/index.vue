  ...
  <header class="header" :class="burger ? 'activeBurger' : ''">
    <div class="header_container">
      ...
      <div v-if="!device" class="header_auth">
        <PrismicLink class="header_auth-in" :field="slice.primary.linkIn">{{
          slice.primary.linkInTitle
        }}</PrismicLink>

        <PrismicLink class="header_auth-reg" :field="slice.primary.linkAuth">{{
          slice.primary.linkAuthTitle
        }}</PrismicLink>
        ...
        <div v-show="burger" class="header_collapse">
          <div class="header_inner">
            ...
            <div class="header_auth">
              <PrismicLink
                class="header_auth-in"
                :field="slice.primary.linkIn"
                >{{ slice.primary.linkInTitle }}</PrismicLink
              >

              <PrismicLink
                class="header_auth-reg"
                :field="slice.primary.linkAuth"
                >{{ slice.primary.linkAuthTitle }}</PrismicLink
              >
